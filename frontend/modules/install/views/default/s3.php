            ...
            <section class="section">
                ...
                <form id="J_install_form" action="?step=4" method="post">
                    ...
                    <div class="server">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="dbprefix" id="dbprefix" value="yan_" readonly class="input"></td>
...
<!--                                <td><input type="text" name="sitename" value="东研建站系统" class="input"></td>-->
...
<!--                            <tr>-->
<!--                                <td class="tar">关键词：</td>-->
<!--                                <td><input type="text" name="sitekeywords" value="东研科技" class="input" autoComplete="off"></td>-->
<!--                                <td><div id="J_install_tip_sitekeywords"></div></td>-->
<!--                            </tr>-->
<!--                            <tr>-->
<!--                                <td class="tar">描述：</td>-->
<!--                                <td><textarea class="input" name="siteinfo">东研科技，技术点亮价值</textarea></td>-->
...
<!--                        </table>-->
            ...
            <div  style="width:0;height:0;overflow:hidden;"> <img src="<?= Yii::getAlias('@web/')?>frontend/modules/install/images/pop_loading.gif"> </div>
            <script src="<?= Yii::getAlias('@web/')?>frontend/modules/install/js/jquery.js?v=9.0"></script>
            <script src="<?= Yii::getAlias('@web/')?>frontend/modules/install/js/validate.js?v=9.0"></script>
            <script src="<?= Yii::getAlias('@web/')?>frontend/modules/install/js/ajaxForm.js?v=9.0"></script>
            <script>
                function TestDbPwd()
                {
