...
/**
 * FriendController implements the CRUD actions for Banner model.
 */
class FriendController extends BackendController
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Friend::find()->orderBy('id DESC'),
        ]);
    ...
    protected function upload($model)
    {
        ...
        if($uploadModel->file)
        {
            if($uploadModel->validate())
            {
                ...
                $savepath = $uploadRoot.'uploads/friend/';
